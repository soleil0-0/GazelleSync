...
class TorrentMetadata(object):
	...
	def save(self, torrent_path, progress=None):
		...
		if os.path.isdir(self.data_path):
			...
			for size, path in files:
				...
				#	fs[-1]['attr'] = 'p'
				#else:
				#print (self.data_path, path, "==>", os.path.join(self.data_path, *path))
		...
		#f = open(os.path.abspath(torrent_path), 'wb')
		#f.write(bencode(utf8_encode_structure(torrent)))
		#f.close()
	...
	def get_source(self):
		"""Get the torrent source.

		Returns:
			str: The source of the torrent.

		"""
		return self.__source

	def set_source(self, source):
		"""Set the source for the torrent.

		Args:
			source (str): The source of the torrent.
